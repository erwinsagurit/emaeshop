                ...
                <div class="bottom-footer">
                    <div class="row">
                        <div class="col-xs-12 col-sm-3 payment-options color-gray">
                            ...
                            <ul>
                                <li>
                                    <a href="https://www.paypal.com/ph/home" target="_blank"> <img src="" alt="" >Paypal </a>
                                </li>
                                <li>
                                    <a href="https://www.maya.ph/" target="_blank"> <img src="" alt="">Maya </a>
                                </li>
                                <li>
                                    <a href="https://www.gcash.com/" target="_blank"> <img src="" alt=""> Gcash</a>
                                </li>
                                <li>
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Contact us</h5>
                                    <p>email: erwinsagurit0@gmail.com</p>
                                    <p>contact: 09633037584</p>
                                    <p>Address: San Manuel</p>
                                    <h5></a></h5> </div>
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                    <h5>Addition informations</h5>
                                   <p>This is our capstone project. We are the Developers from BSIT 4C.</p>
                                </div>
                    </div>
                </div>
            </div>
